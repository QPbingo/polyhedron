...
- [ ] **Step 1: Write failing backend wire tests**
...
- [ ] **Step 3: Write failing frontend offset cursor tests**
...
- [ ] **Step 4: Run the frontend protocol test and verify RED**
...
- [ ] **Step 5: Implement the shared contracts and frame validation**
...
- [ ] **Step 1: Write failing journal durability and privacy tests**
...
- [ ] **Step 3: Implement crypto and journal schema**
...
- [ ] **Step 6: Implement idempotent migration and permanent retention**
...
- [ ] **Step 7: Run the complete store suite**
...
- [ ] **Step 1: Write failing fail-closed operation tests**
...
- [ ] **Step 3: Implement the recorded operation pipeline**
...
- [ ] **Step 4: Write failing output/parser/Hook tests**
...
- [ ] **Step 5: Run output and Hook tests and verify RED**
...
- [ ] **Step 6: Implement output, exit and Hook fact ordering**
...
- [ ] **Step 1: Write failing attach/control concurrency tests**
...
- [ ] **Step 3: Implement channel-bound subscribers and sync watermarks**
...
- [ ] **Step 4: Implement offset ACK/backpressure**
...
- [ ] **Step 5: Run Host and concurrency suites**
...
- [ ] **Step 1: Write failing Relay minimization tests**
...
- [ ] **Step 2: Run minimization tests and verify RED**
...
- [ ] **Step 3: Remove projection persistence and plaintext routing**
...
- [ ] **Step 4: Make Connector loss explicit**
...
- [ ] **Step 1: Write failing cryptographic channel tests**
...
- [ ] **Step 3: Implement versioned authenticated handshake and envelopes**
...
- [ ] **Step 4: Integrate sealed RPC and event delivery**
...
- [ ] **Step 5: Run crypto, auth and type suites**
...
- [ ] **Step 1: Update Playwright fixtures and write failing interaction tests**
...
- [ ] **Step 3: Implement Host-sourced state loading and offset terminal rendering**
...
- [ ] **Step 4: Implement explicit ownership and failure UI**
...
- [ ] **Step 5: Run frontend unit, Playwright, typecheck and build**
...
- [ ] **Step 1: Write failing real-stack fault tests**
...
- [ ] **Step 2: Run real-stack tests and verify RED**
...
- [ ] **Step 3: Complete fixture and recovery wiring**
...
- [ ] **Step 4: Add Relay privacy inspection**
...
- [ ] **Step 2: Run the real development stack and browser smoke**
...
- [ ] **Step 3: Audit requirements and sensitive persistence**
...
- [ ] **Step 5: Use the finishing workflow and push `main`**
